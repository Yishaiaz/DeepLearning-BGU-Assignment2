...
hp.Boolean('enable_l2_regularizer')
hp.Boolean('enable_dropout')
...
hp.Choice('dropout_rate', [0.1, 0.2, 0.3, 0.5, 0.7])
hp.Choice('distance_metric', ["abs", "euclidean_distance"])
hp.Float('l2_regularizer', min_value=0.001, max_value=0.2, default=None)
